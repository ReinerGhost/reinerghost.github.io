(function () {
    ...
    Maid = new Page('Maid', function (name) {
        // console.log(name);
        var self = this;
        var userData = getUserData();
        ...
        self.render({ 'Settings' : settings, 'User': getUserData() }, function () {
            $('.maid-form-first-step [name="bedrooms"]').change(styledSelector);
            styledSelector.call($('.maid-form-first-step [name="bedrooms"]')[0]);
            //bedrooms
            $('.maid-form-first-step [name="bathrooms"]').change(styledSelector);
            styledSelector.call($('.maid-form-first-step [name="bathrooms"]')[0]);
            //bathrooms
            $('.maid-form-first-step [name="clean_type"]').change(function() {
                MaidOrder('clean_type', 0);
                styledSelector;
            });
            //clean type
            $('.maid-form-first-step [name="frequency"]').change(styledSelector);
            styledSelector.call($('.maid-form-first-step [name="frequency"]')[0]);
            //frequency
            ...
            $('button.second-step').click(function () {
                try {
                    ...
                    globalData['data'] = cache; globalData['textData'] = getDataText(cache); globalData['title'] = 'HOME CLEANING'; globalData['goBack'] = 'Maid';
                    $('.loading-block').show();
